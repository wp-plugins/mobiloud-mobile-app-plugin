...
<?php if(get_option('ml_eager_loading_enable') == 'true' || $post_type == 'page') { ?>

<?php include(dirname(__FILE__)."/body_content.php"); ?>
<?php } else { ?>

<div id="lazy_body">
</div><div data-post_id="<?php echo $post->ID; ?>" data-url="<?php echo MOBILOUD_PLUGIN_URL; ?>/post/content_json.php" id="mobiloud_lazy_load">
