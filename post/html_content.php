...
<?php if(get_option('ml_eager_loading_enable') == 'true' || $eager_loading == "true" || $post_type == 'page') { ?>
...
</h1></div><div id="lazy_content_spinner">
</div></div><div data-post_id="<?php echo $post->ID; ?>" data-url="<?php echo MOBILOUD_PLUGIN_RELATIVE_URL; ?>/post/body_content.php" id="mobiloud_lazy_load">
