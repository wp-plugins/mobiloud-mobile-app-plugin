...
function iphone_html($post)
{
	...
	$header .= "<link rel=\"StyleSheet\" href=\"".plugin_dir_url(__FILE__)."post_html/css/iphone.css\" type=\"text/css\"  media=\"screen\">";

	$header .= "<link rel=\"StyleSheet\" href=\"".plugin_dir_url(__FILE__)."post_html/css/iphone_portrait.css\" type=\"text/css\"  media=\"screen\" id=\"orient_css\">";
	$header .= "</head>";
