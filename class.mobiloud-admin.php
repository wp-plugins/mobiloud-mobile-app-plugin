...
//        add_action('admin_head', 'ml_init_getvero');
    ...
    public static function admin_menu() {
        ...
        add_menu_page('Mobiloud', 'Mobiloud', 'activate_plugins', 'mobiloud', array('Mobiloud_Admin', 'menu_get_started'), MOBILOUD_PLUGIN_URL . "assets/img/ml-menu-icon.svg", '25.90239843209');
