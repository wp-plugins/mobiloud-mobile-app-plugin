<div id="wrap" class="mobiloud">
    <div id="ml-header">
        ...
        <a href="http://www.mobiloud.com/pricing/" target="_blank" class="pricing-btn button-primary">
        ...
        <?php else: ?>
        Have a question or need help? <a class="ml-intercom ml-contact-button button button-primary" href="mailto:h89uu5zu@incoming.intercom.io" data-intercom_original_html="Contact Us" style="visibility: visible;">Contact Us</a>
        <?php endif; ?>
   </div>